...
#define DEBUG_MQTT (1 << 8)
#define DEBUG_ALL (DEBUG_GSM | AT_COMMANDS | DEBUG_RS485 | DEBUG_ADC | DEBUG_ADC_IN | DEBUG_FLASH | DEBUG_EEPROM | DEBUG_OTHER | DEBUG_MQTT)
#define DEBUG_NONE 0
...
#define STATUS_MQTT_AUTH_ERROR        (1u<<25)
#define STATUS_MQTT_CONN              (1u<<26)
#define STATUS_MQTT_SUB_SETTINGS      (1u<<27)
#define MQTT_SEARCH (1u<<28)
