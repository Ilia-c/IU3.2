...
#define DEFAULT_VERSION_PROGRAMM       "Ver0.61"    // Версия программы
#define EEPROM_FORMAT_VERSION           0x00000004U // Версия формата данных EEPROM
