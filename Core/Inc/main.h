...
#define EN_5_Pin GPIO_PIN_0
#define EN_5_GPIO_Port GPIOC
#define EN_3P3_Pin GPIO_PIN_1
#define EN_3P3_GPIO_Port GPIOC
#define EN_3P8_Pin GPIO_PIN_2
...
#define ON_ADC_Pin GPIO_PIN_6
#define ON_ADC_GPIO_Port GPIOC
#define ON_t_Pin GPIO_PIN_7
#define ON_t_GPIO_Port GPIOC
