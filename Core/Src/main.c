...
int main(void)
{
  ...
  RS485_dataHandle = osThreadNew(RS485, NULL, &RS485_data_attributes);

  /* creation of SIM800_data */
  SIM800_dataHandle = osThreadNew(SIM800_data, NULL, &SIM800_data_attributes);

  /* creation of Main */
  MainHandle = osThreadNew(Main_fun, NULL, &Main_attributes);

  /* creation of Keyboard_task */
  Keyboard_taskHandle = osThreadNew(Keyboard, NULL, &Keyboard_task_attributes);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, DC_display_Pin|RES_display_Pin|ADC_ON_OFF_Pin|Col_b2_Pin
                          |Col_b1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, Display_ON_OFF_Pin|SPI_2_SS_Pin|DCDC__ON_OFF_Pin|GSM_ON_OFF_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, Data_FES_ON_OFF_Pin|RS485__ON_OFF_Pin|Col_b4_Pin|Col_b3_Pin
                          |Temp_ON_OFF_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : DC_display_Pin RES_display_Pin ADC_ON_OFF_Pin Col_b2_Pin
                           Col_b1_Pin */
  GPIO_InitStruct.Pin = DC_display_Pin|RES_display_Pin|ADC_ON_OFF_Pin|Col_b2_Pin
                          |Col_b1_Pin;
  ...
  /*Configure GPIO pins : Display_ON_OFF_Pin SPI_2_SS_Pin DCDC__ON_OFF_Pin GSM_ON_OFF_Pin */
  GPIO_InitStruct.Pin = Display_ON_OFF_Pin|SPI_2_SS_Pin|DCDC__ON_OFF_Pin|GSM_ON_OFF_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : Data_FES_ON_OFF_Pin RS485__ON_OFF_Pin Col_b4_Pin Col_b3_Pin
                           Temp_ON_OFF_Pin */
  GPIO_InitStruct.Pin = Data_FES_ON_OFF_Pin|RS485__ON_OFF_Pin|Col_b4_Pin|Col_b3_Pin
                          |Temp_ON_OFF_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
/* USER CODE BEGIN Header_Main_fun */
/**
* @brief Function implementing the Main thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Main_fun */
void Main_fun(void *argument)
{
  /* USER CODE BEGIN Main_fun */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END Main_fun */
}
