...
void MX_ADC1_Init(void)
{
 ...
 void MX_TIM5_Init(void)
 {
     ...
     htim5.Instance = TIM5;
     htim5.Init.Prescaler = 40000-1;                       // ѕредделитель (40 ћ√ц / 40 000 = 1 к√ц)
     htim5.Init.CounterMode = TIM_COUNTERMODE_UP;
     htim5.Init.Period = 20000-1;                          // ѕериод (1 к√ц / 20 000 = 0.05 √ц или 20 сек)
 ...
 void MX_ADC3_Init(void)
 {
   ...
   hadc3.Instance                      = ADC3;
   hadc3.Init.ClockPrescaler          = ADC_CLOCK_ASYNC_DIV1;     // ƒелитель тактировани€
   hadc3.Init.Resolution              = ADC_RESOLUTION_12B;       // 12 бит
   hadc3.Init.DataAlign               = ADC_DATAALIGN_RIGHT;
   hadc3.Init.ScanConvMode            = ADC_SCAN_DISABLE;         // ќдин канал
   hadc3.Init.EOCSelection            = ADC_EOC_SEQ_CONV;
   hadc3.Init.LowPowerAutoWait        = DISABLE;
   hadc3.Init.ContinuousConvMode      = ENABLE;                  // ќдиночное преобразование
   ...
   // Ќастраиваем регул€рный канал Ч PC0 = Channel 1 (ADC123_IN1)
   sConfig.Channel      = ADC_CHANNEL_1;
   sConfig.Rank         = ADC_REGULAR_RANK_1;
   sConfig.SamplingTime = ADC_SAMPLETIME_24CYCLES_5; // ѕри необходимости выбрать больше (например, 47.5 или 92.5)
   sConfig.SingleDiff   = ADC_SINGLE_ENDED;
   sConfig.OffsetNumber = ADC_OFFSET_NONE;
   sConfig.Offset       = 0;
 ...
 {
   hi2c2.Instance = I2C2;
   hi2c2.Init.Timing = 0x4021060F;//0x00F12981;
