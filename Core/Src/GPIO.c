...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, RESERVED_Pin|COL_B4_Pin|ON_OWEN_1_Pin|ON_OWEN_2_Pin
                          |ON_OWEN_3_Pin|EN_3P3V_Pin|ON_RS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, UART4_WU_Pin|EN_5V_Pin|ON_DISP_Pin|EN_3P8V_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, COL_B3_Pin|COL_B2_Pin|COL_B1_Pin|SPI2_CS_ADC_Pin
                          |SPI2_CS_ROM_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : RESERVED_Pin COL_B4_Pin ON_OWEN_1_Pin ON_OWEN_2_Pin
                           ON_OWEN_3_Pin EN_3P3V_Pin ON_RS_Pin */
  GPIO_InitStruct.Pin = RESERVED_Pin|COL_B4_Pin|ON_OWEN_1_Pin|ON_OWEN_2_Pin
                          |ON_OWEN_3_Pin|EN_3P3V_Pin|ON_RS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : UART4_WU_Pin EN_5V_Pin ON_DISP_Pin EN_3P8V_Pin */
  GPIO_InitStruct.Pin = UART4_WU_Pin|EN_5V_Pin|ON_DISP_Pin|EN_3P8V_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
